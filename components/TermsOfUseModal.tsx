  ...
  return (
    <Modal onClose={onClose}>
      ...
      <div className="p-6 md:p-8 overflow-y-auto custom-scrollbar text-gray-400 space-y-4 text-sm">
        ...
        <p>By accessing the website at tresordesign.com, you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws.</p>
        <h3 className="font-bold text-white pt-2">1. Use License</h3>
        <p>Permission is granted to temporarily download one copy of the materials (information or software) on Tresor Design Creative Studio's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title.</p>
        <h3 className="font-bold text-white pt-2">2. Disclaimer</h3>
        <p>The materials on Tresor Design Creative Studio's website are provided on an 'as is' basis. Tresor Design Creative Studio makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</p>
        <h3 className="font-bold text-white pt-2">3. Limitations</h3>
        <p>In no event shall Tresor Design Creative Studio or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Tresor Design Creative Studio's website.</p>
