  ...
  return (
    <Modal onClose={onClose}>
      ...
      <div className="p-6 md:p-8 overflow-y-auto custom-scrollbar text-gray-400 space-y-4 text-sm">
        ...
        <p>Your privacy is important to us. It is Tresor Design Creative Studio's policy to respect your privacy regarding any information we may collect from you across our website.</p>
        ...
        <p>Our website may use cookies to enhance user experience. You have the option to accept or refuse these cookies, and know when a cookie is being sent to your computer. If you choose to refuse our cookies, you may not be able to use some portions of our Service.</p>
