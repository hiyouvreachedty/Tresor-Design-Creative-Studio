...
const AboutMeModal: React.FC<AboutMeModalProps> = ({ onClose }) => {
  ...
  return (
    <Modal onClose={onClose} maxWidth="max-w-4xl">
      <header className="p-4 flex justify-between items-center border-b border-white/10 shrink-0 font-mono bg-black/30">
        <div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8">
          ...
          <div className="space-y-4">
            <div className="relative border-2 border-white/10 p-1 bg-black">
              <img 
                src={profileImageUrl} 
              ...
              <span className="absolute top-2 left-2 text-xs font-mono bg-black/50 px-2 py-1 text-[--color-neon-green]">SUBJECT IDENTIFIED</span>
            </div>
